...
{
	int memIndex = index;
	if (isDigit(str[index++]) && isNatural(str, index))
	{
		++index;
		return true;
	}
...
{
	int memIndex = index;
	if (str[index++] == 'E' && isNatural(str, index))
	{
		++index;
		return true;
	}
	index = memIndex;
	if (str[index++] == 'E' && isSign(str[index++]) && isNatural(str, index))
	{
		++index;
		return true;
	}
...
{
	int memIndex = index;
	if (isSign(str[index++]) && isMantissa(str, index) && isExp(str, index))
	{
		return true;
	}
	if (isMantissa(str, index) && isExp(str, index))
	{
			return true;
	}
	index = memIndex;
